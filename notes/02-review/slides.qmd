...
We can estimate a regression line in [R]{.mono } (`lm(y ~ x, my_data)`).
...
::: {.fragment}
[OLS *t* test]{.hi-slate } Our (null) hypothesis states that $\beta_1$ equals a value $c$, _i.e._, $H_o:\: \beta_1 = c$
...
## Uncertainty and inference {visibility="hidden"}
