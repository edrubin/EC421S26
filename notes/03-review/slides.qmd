...
- Incredibly powerful graphing and mapping package for [R]{.mono }.
...
We're moving from **simple linear regression** (one [outcome variable]{.pink } and one [explanatory variable]{.purple })

$$ \textcolor{#e64173}{y_i} = \beta_0 + \beta_1 \textcolor{#6A5ACD}{x_i} + u_i $$

to the land of **multiple linear regression** (one [outcome variable]{.pink } and multiple [explanatory variables]{.purple })

$$ \textcolor{#e64173}{y\_i} = \beta\_0 + \beta\_1 \textcolor{#6A5ACD}{x\_{1i}} + \beta\_2 \textcolor{#6A5ACD}{x\_{2i}} + \cdots + \beta\_k \textcolor{#6A5ACD}{x\_{ki}} + u\_i $$
...
Our residualized $x_{1}$ (which we named $\textcolor{#e64173}{\tilde{x}_1}$) comes from regressing $x_1$ on an intercept and all of the other explanatory variables and collecting the residuals, _i.e._,

$$
\begin{aligned}
  \hat{x}_{1i} &= \hat{\gamma}_0 + \hat{\gamma}_2 \, x_{2i} + \hat{\gamma}_3 \, x_{3i} \\
  \textcolor{#e64173}{\tilde{x}_{1i}} &= x_{1i} - \hat{x}_{1i}
\end{aligned}
$$
...
[[†]{.pink } As is often the case with econometrics.]{.footnote }
...
$$ y\_i = \textcolor{#e64173}{\hat{\beta}\_{0}} + \textcolor{#e64173}{\hat{\beta\_1}} \, x\_{1i} + \textcolor{#e64173}{\hat{\beta\_2}} \, x\_{2i} + \cdots + \textcolor{#e64173}{\hat{\beta}\_{k}} \, x\_{ki} + e\_i $$
...
If you run a regression<sup>†</sup> with missing values, [R]{.mono } drops the observations missing those values.
