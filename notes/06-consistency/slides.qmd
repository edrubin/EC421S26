...
the [*probability limit*]{.pink } helps us analyze [the asymptotic distribution of an estimator]{.b .pink } (the distribution of the estimator as $n$ gets "big"<sup>[†]{.pink }</sup>).
...
^[[†]{.pink } You will often hear the term "omitted-variable bias" when we're actually talking about inconsistency (rather than bias).]
