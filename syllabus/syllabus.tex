...
\begin{tabular}{@{\extracolsep{5pt}} l l l l l @{}}
	...
	\faClockO & Tu. \& Th. 12:00p--1:20p & We. 3:00p--3:50p Zoom \& Async. \\
	\faMapMarker & \href{https://classrooms.uoregon.edu/gerlinger-302/}{Gerlinger 302} & Zoom \& Canvas recording \\
	\faUser & \textbf{Edward Rubin} & \textbf{Connor Mulholland} \\
  \faPaperPlaneO & \href{mailto:edwardr@uoregon.edu}{edwardr@uoregon.edu} & \href{mailto:cmulhol2@uoregon.edu}{cmulhol2@uoregon.edu} \\ 
  & \multicolumn{3}{l}{Use ``\texttt{EC421}'' in email subject.} \\
  \faChevronRight & \multicolumn{2}{l}{Course page: \href{https://github.com/edrubin/EC421S26}{https://github.com/edrubin/EC421S26}} \\
  \faChevronRight & \href{https://edrub.in}{edrub.in} & \href{https://cas.uoregon.edu/directory/social-sciences/all/cmulhol2}{UO page} \\
  \faQuestionCircleO & Th. 2:00p--3:30p (\href{https://map.uoregon.edu/b83e556a1}{PLC 530}) & 3:30p--4:30p (\href{https://map.uoregon.edu/0669fd239}{PLC 506}) & \\ 
...
\begin{tabular}{@{\extracolsep{5pt}} lll @{}}
  ...
  \faChevronRight & \href{https://github.com/edrubin/EC421W26}{https://github.com/edrubin/EC421W26} & 421, Winter 2026 course on GitHub\\
  \faChevronRight & \href{https://github.com/edrubin/EC421S25}{https://github.com/edrubin/EC421S25} & 421, Spring 2025 course on GitHub\\
...
\begin{tabular}{@{\extracolsep{5pt}} r l ll @{}}
  ...
  & & 3:00p--3:50p (PST), Zoom & Recorded \\
  & & Zoom (links on Canvas) & Zoom (links on Canvas) \\
  Lab instructor & & \textbf{Connor Mulholland} & \textbf{Connor Mulholland} \\
  & & \href{mailto:cmulhol2@uoregon.edu}{cmulhol2@uoregon.edu} & \href{mailto:cmulhol2@uoregon.edu}{cmulhol2@uoregon.edu} \\
\end{tabular}
\end{table}
...
\paragraph{Exams}
\begin{itemize}
  \item The \textbf{in-class midterm is tentatively planned for Thursday, 07 May 2026 (during class)}.
  \item The \textbf{in-person final exam will be \href{https://registrar.uoregon.edu/dates-deadlines/exams}{Monday, 08 June 2026, 8:00a--10:00a}}.
\end{itemize}
...
\begin{table}[htb]
  ...
  \begin{tabular}{@{\extracolsep{1cm}} c c c l l @{}}
    ...
    Class & Week & Date & Topics & Suggested readings  \\ \toprule
      \texttt{01} & \texttt{01} & 03/31 & Intro & ItE 1--6 \\
      \texttt{02} & \texttt{01} & 04/02 & Review & ItE 1--6; MM 2 \\
      \texttt{03} & \texttt{02} & 04/07 & Review & ItE 1--7 \\
      \texttt{04} & \texttt{02} & 04/09 & Review & ItE 1--7 \\
      \texttt{05} & \texttt{03} & 04/14 & Heteroskedasticity & ItE 7 \\
      \texttt{06} & \texttt{03} & 04/16 & Heteroskedasticity & ItE 7 \\
      \texttt{07} & \texttt{04} & 04/21 & Consistency (and Inconsistency) & ItE pp. 68--75  \\
      \texttt{08} & \texttt{04} & 04/23 & Time Series & ItE 11  \\
      \texttt{09} & \texttt{05} & 04/28 & Time Series & ItE 11  \\
      \texttt{10} & \texttt{05} & 04/30 & Autocorrelation \& Nonstationarity & ItE 12 \& 13 \\
      \texttt{11} & \texttt{06} & 05/05 & Midterm Review & ItE 12 \\
      \midrule
      \texttt{12} & \texttt{06} & 05/07 & \textbf{Midterm} \\ 
      \midrule
      \texttt{13} & \texttt{07} & 05/12 & Causality & MM 1 \\ 
      \texttt{14} & \texttt{07} & 05/14 & Causality & MM 1 \\
      \texttt{15} & \texttt{08} & 05/19 & Causality & MM 1 \\
      \texttt{16} & \texttt{08} & 05/21 & Instrumental Variables & ItE 9; MM 3 \\
      \texttt{17} & \texttt{09} & 05/26 & Instrumental Variables & ItE 9; MM 3 \\
      \texttt{18} & \texttt{09} & 05/28 & Panel Methods & MM 5 \\
      \texttt{19} & \texttt{10} & 06/02 & Panel Methods & MM 5 \\
      \texttt{20} & \texttt{10} & 06/04 & Review \\
    \midrule
    \texttt{  } & \texttt{11} & 06/08 & \textbf{In-class final exam, \href{https://registrar.uoregon.edu/dates-deadlines/exams}{8a--10a}} & \\
    \bottomrule
  \end{tabular}
\end{table}
